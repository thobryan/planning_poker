...
2. Update the placeholders:
   ...
   - `ERROR_EMAIL_MAX_PER_WINDOW` / `ERROR_EMAIL_WINDOW_SECONDS`: rate-limit crash email volume (defaults: 10 emails per 5 minutes). Set the max to 0 to disable throttling.
